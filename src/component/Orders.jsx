...
function Orders() {
  ...
  const subtotal = filteredOrders.reduce((acc, item) => acc + item.price * item.qty, 0);
    ...
    >
            ...
            <div key={index} className="bg-[#262837] p-4 rounded-xl">
              ...
              <div className="flex gap-3 mt-3 ">
                ...
                <button
                  ...
                  className="border border-pink-500 text-pink-500 p-2 rounded-lg hover:bg-pink-500 hover:text-white transition"
                >
                  <Trash2 size={16} />
                </button>
              </div>
      ...
      <div className="border-t border-gray-700 p-6">
        ...
        <button
          ...
          onClick={() => onConfirmOrder({ orders: filteredOrders, category })}
          className={`w-full mt-4 py-3 rounded-xl font-semibold ${
            filteredOrders.length === 0 ? "bg-gray-600 cursor-not-allowed" : "bg-orange-500"
          }`}
        >
          Order Now
        </button>
